...
import { mockRiders, mockVehicles, mockSettings } from '@/lib/data';
                    ...
                    <CardContent className="space-y-8 min-h-[200px]">
                                            ...
                                            <SelectContent>
                                                {availableVehicles.length > 0 ? (
                                                    availableVehicles.map((vehicle) => (
                                                        <SelectItem key={vehicle.id} value={vehicle.id}>{vehicle.make} {vehicle.model} - {vehicle.registrationNumber}</SelectItem>
                                                    ))
                                                ) : (
                        ...
                        {step === STEPS.CONFIRM && (
                            <div className="space-y-4 rounded-lg border p-4">
                                ...
                                <p><strong>Vehicle:</strong> {selectedVehicle?.make} {selectedVehicle?.model} ({selectedVehicle?.registrationNumber})</p>
