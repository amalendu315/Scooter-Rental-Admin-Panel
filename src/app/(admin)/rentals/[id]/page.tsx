                    ...
                    <Card>
                        ...
                        <CardContent className="grid gap-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <Link href={`/vehicles/${rental.vehicle.id}`} className="text-primary hover:underline">{rental.vehicle.make} {rental.vehicle.model}</Link>
                            ...
                            <Dialog>
                                ...
                                <DialogContent className="sm:max-w-[425px]">
                                    ...
                                    <div className="space-y-4 py-4 text-sm">
                                        ...
                                        <p><strong>Vehicle:</strong> {rental.vehicle.make} {rental.vehicle.model}</p>
