import { Rider, Vehicle, Rental, Payment, Alert, Staff, Settings } from './types';

export const mockRiders: Rider[] = [
    { id: '1', fullName: 'Aarav Sharma', phone: '9876543210', email: 'aarav.sharma@example.com', address: '123 MG Road', city: 'Mumbai', idProofType: 'Aadhaar', idProofNumber: '1234 5678 9012', documentExpiryDate: '2030-12-31', status: 'active', kycDocuments: [{ name: 'Aadhaar Card.pdf', url: '#' }], rentalsCount: 5, totalSpent: 25000 },
    { id: '2', fullName: 'Diya Patel', phone: '9876543211', email: 'diya.patel@example.com', address: '456 Park Street', city: 'Delhi', idProofType: 'Passport', idProofNumber: 'Z1234567', documentExpiryDate: '2028-05-20', status: 'active', kycDocuments: [], rentalsCount: 2, totalSpent: 12000 },
    { id: '3', fullName: 'Rohan Mehta', phone: '9876543212', email: 'rohan.mehta@example.com', address: '789 Lake View', city: 'Bangalore', idProofType: 'DL', idProofNumber: 'DL0120200001234', documentExpiryDate: '2024-08-15', status: 'blocked', kycDocuments: [{ name: 'Driving License.jpg', url: '#' }], rentalsCount: 1, totalSpent: 3500 },
];
